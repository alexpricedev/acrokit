...
export function RandomFlowModal({ isOpen, onClose, onGenerate }: RandomFlowModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900">Create random flow</h2>
          <button
            onClick={handleClose}
          ...
          <div>
            ...
            <div>
              ...
              <input
                ...
                max="20"
                value={moveCount}
                onChange={(e) => setMoveCount(Math.max(1, Math.min(20, parseInt(e.target.value) || 1)))}
