      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900">
            {isCodeSent ? 'Check your email' : 'Welcome back to AcroKit'}
          </h2>
          <button
            onClick={handleClose}
        ...
        {isCodeSent ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-sm text-gray-500 mt-4 text-center">
              Save your flows, access them anywhere, and build your personal acroyoga library. We'll send you a 6-digit code - works for new and existing accounts!
            </p>
          </form>
        )}
      </div>
