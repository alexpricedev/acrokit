...
export function SharedFlowLoader({ flowId, onFlowLoad, onError }: SharedFlowLoaderProps) {
    ...
    return (
      <div className="max-w-7xl mx-auto p-6">
        <div className="text-center py-12">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Loading shared flow...</h2>
